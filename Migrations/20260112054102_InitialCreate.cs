        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NetPayable = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientInsuranceMappings", x => x.MappingId);
                    table.ForeignKey(
                        name: "FK_PatientInsuranceMappings_InsurancePolicies_PolicyId",
                        column: x => x.PolicyId,
                        principalTable: "InsurancePolicies",
                        principalColumn: "PolicyId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PatientInsuranceMappings_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientInsuranceMappings_PatientId",
                table: "PatientInsuranceMappings",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientInsuranceMappings_PolicyId",
                table: "PatientInsuranceMappings",
                column: "PolicyId");
